...
public class LowerMap<V> extends HashMap<String, V> {
    @Override
    ...
    public void putAll(Map<? extends String, ? extends V> m) {
        m.forEach((k, v) -> this.put(k.toLowerCase(Locale.ROOT), v));
    }

    @Override
    public V getOrDefault(Object key, V defaultValue) {
        return super.getOrDefault(key.toString().toLowerCase(Locale.ROOT), defaultValue);
    }
    ...
    public boolean remove(Object key, Object value) {
        return super.remove(key.toString().toLowerCase(Locale.ROOT), value);
    }
    ...
    public V remove(Object key) {
        return super.remove(key.toString().toLowerCase(Locale.ROOT));
    }
}
